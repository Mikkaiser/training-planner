...
import { ChevronRight, GripVertical, Layers, Pencil, X } from "lucide-react";
...
import type { PlanPhaseRef, Phase, Subcompetence } from "@/lib/training-plans/types";
import { cn } from "@/lib/utils";
import { PhaseEditDialog } from "@/components/training-plans/phase-edit-dialog";
      ...
      >
        <div className="absolute right-2 top-2 flex items-center gap-1">
          <button
            ...
            className="rounded-md p-1 text-tp-muted hover:bg-[var(--hover-tint-bg)] hover:text-tp-primary"
