  ...
  return (
    <div className="flex min-h-[60vh] items-center justify-center p-6">
      <div className="glass w-full max-w-md rounded-xl border border-border p-5">
        <div className="text-lg font-semibold text-tp-primary">Reset password failed</div>
        <div className="mt-2 text-sm text-tp-secondary">
          Please retry. If your link expired, request a new reset link.
        </div>
        <div className="mt-4 flex gap-3">
          <button type="button" onClick={reset} className="tp-plan-save-btn flex-1">
            Retry
          </button>
          <Link href="/forgot-password" className="tp-ghost-btn flex-1 text-center">
            New link
          </Link>
        </div>
